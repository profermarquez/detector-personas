...
cv2.namedWindow('Camara a tiempo real')
cv2.setMouseCallback('Camara a tiempo real',RGB)
cap=cv2.VideoCapture(0) #0 es la webcam
...
#        print(row)
    ...
    cv2.imshow("Camara a tiempo real", frame)
